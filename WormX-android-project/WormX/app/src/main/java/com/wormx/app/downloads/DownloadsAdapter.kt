...
class DownloadsAdapter(
    ...
    private val onConvertToMp3: (DownloadItem) -> Unit = {}
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bind(items[position], onPauseResume, onCancel, onMoveToVault, onConvertToMp3)
    }
    ...
    class ViewHolder(private val binding: ItemDownloadBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(
            ...
            onConvertToMp3: (DownloadItem) -> Unit
        ) {
            ...
            binding.fileName.setOnLongClickListener {
                if (canConvert) onConvertToMp3(item)
                canConvert
            }
        }
    }
