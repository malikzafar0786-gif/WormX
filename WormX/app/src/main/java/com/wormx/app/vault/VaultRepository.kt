    ...
    fun hideFromGallery(uri: Uri): ImportResult {
        ...
        try {
            try {
                ...
                // Photo Picker URIs are typically single-use/session-scoped and
                // don't support a persistable grant — that's fine, we only
                // need read access for the copy happening right now anyway.
            }
